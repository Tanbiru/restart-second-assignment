...
const Tickets = ({ ticketData, onTicketSelect, onTicketComplete }) => {
...
<> <ToastContainer />
  ...
  <div className="mt-10 w-10/12 mx-auto flex flex-col lg:flex-row lg:justify-around gap-10">
    ...
    <div className="order-2 lg:order-1">
      <h3 className='text-2xl font-semibold text-[#34485A] pb-5'>
        Customer Tickets
      </h3>
              ...
              <div key={ticket.id}>
                <div className="w-full">
                  ...
                  <a
                    ...
                    className="block border border-gray-300 rounded-md p-5 shadow-sm bg-white hover:shadow-md active:scale-[0.99] transition duration-200"
                  >
    ...
    <div className="order-1 lg:order-2">
...

      {
        selectedTickets.length > 0 ? (
            ...
            <div key={ticket.id} className="card w-full bg-base-100 card-sm shadow-sm mb-5">
              ...
              <div className="card-body items-center">
                ...
                <button
                  ...
                  className="btn btn-wide bg-[#02A53B] text-white hover:bg-[#028a30]"
                >
                  Complete
                </button>
          ...
          <p className='text-xl text-[#627382] mb-5'>
            No tasks selected.
          </p>
        )
      }
        ...
        resolvedTickets.length > 0 ? (
          resolvedTickets.map(ticket => (
            ...
            <div key={ticket.id} className="mb-2 bg-gray-50 rounded-xl">
              ...
              <p className='text-lg text-[#627382] p-4'>
                {ticket.title}
              </p>
